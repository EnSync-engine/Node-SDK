...
class EnSyncEngine {
  ...
  async #ack(eventIdem, block, eventName) {
    ...
    try {
      ...
      throw new EnSyncError("Failed to acknowledge event. " + e.message, "EnSyncGenericError");
    }
  }
  ...
  async #rollback(eventIdem, block) {
    ...
    try {
      ...
      throw new EnSyncError("Failed to trigger rollback. " + e.message, "EnSyncGenericError");
    }
  }
